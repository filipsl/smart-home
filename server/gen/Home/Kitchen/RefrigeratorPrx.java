...
public interface RefrigeratorPrx extends Home.DevicePrx
{
    default void setFridgeTemperature(Home.Temperature temperature)
        throws Home.TemperatureRangeError
    {
        setFridgeTemperature(temperature, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void setFridgeTemperature(Home.Temperature temperature, java.util.Map<String, String> context)
        throws Home.TemperatureRangeError
    {
        try
        {
            _iceI_setFridgeTemperatureAsync(temperature, context, true).waitForResponseOrUserEx();
        }
    ...
    default java.util.concurrent.CompletableFuture<Void> setFridgeTemperatureAsync(Home.Temperature temperature)
    {
        return _iceI_setFridgeTemperatureAsync(temperature, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> setFridgeTemperatureAsync(Home.Temperature temperature, java.util.Map<String, String> context)
    {
        return _iceI_setFridgeTemperatureAsync(temperature, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_setFridgeTemperatureAsync(Home.Temperature iceP_temperature, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "setFridgeTemperature", null, sync, _iceE_setFridgeTemperature);
    ...
    /** @hidden */
    static final Class<?>[] _iceE_setFridgeTemperature =
    {
        Home.TemperatureRangeError.class
    };

    default Home.Temperature getFridgeTemperature()
        throws Home.SwitchedOffError
    {
        return getFridgeTemperature(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default Home.Temperature getFridgeTemperature(java.util.Map<String, String> context)
        throws Home.SwitchedOffError
    {
        try
        {
            return _iceI_getFridgeTemperatureAsync(context, true).waitForResponseOrUserEx();
        }
    ...
    default java.util.concurrent.CompletableFuture<Home.Temperature> getFridgeTemperatureAsync()
    {
        return _iceI_getFridgeTemperatureAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Home.Temperature> getFridgeTemperatureAsync(java.util.Map<String, String> context)
    {
        return _iceI_getFridgeTemperatureAsync(context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Home.Temperature> _iceI_getFridgeTemperatureAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Home.Temperature> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "getFridgeTemperature", null, sync, _iceE_getFridgeTemperature);
    ...
    /** @hidden */
    static final Class<?>[] _iceE_getFridgeTemperature =
    {
        Home.SwitchedOffError.class
    };

    default void setTempUnit(Home.TempUnit unit)
    {
        setTempUnit(unit, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void setTempUnit(Home.TempUnit unit, java.util.Map<String, String> context)
    {
        _iceI_setTempUnitAsync(unit, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> setTempUnitAsync(Home.TempUnit unit)
    {
        return _iceI_setTempUnitAsync(unit, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> setTempUnitAsync(Home.TempUnit unit, java.util.Map<String, String> context)
    {
        return _iceI_setTempUnitAsync(unit, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_setTempUnitAsync(Home.TempUnit iceP_unit, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "setTempUnit", null, sync, null);
        f.invoke(false, context, null, ostr -> {
                     Home.TempUnit.ice_write(ostr, iceP_unit);
                 }, null);
        return f;
    }
